...
import { Users, Building2, Phone, Mail, MapPin, Calendar, Building, Globe, TrendingUp, Shield, Target } from "lucide-react";
...
const promoters = [
  ...
  { id: 6, name: "SHEARSON INVESTMENTS & TRADING COMPANY PRIVATE LIMITED", category: "Company" },
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-600" data-testid="text-company-exchange">
                      Stock Exchange: BSE
                    </span>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-600" data-testid="text-company-sector">
        ...
        <div className="mb-16 fade-in-up">
          <Card className="glass-card hover-lift shimmer-effect">
            <CardHeader>
              <CardTitle className="text-2xl font-bold gradient-text flex items-center gap-2" data-testid="text-company-secretary-title">
            ...
            <CardContent className="space-y-4">
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Mr. HEMANT AGARWAL</h3>
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="flex items-center gap-2">
                    <Phone className="h-4 w-4 text-blue-600" />
                    <span className="text-sm text-gray-700">+91 9819153922</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Mail className="h-4 w-4 text-green-600" />
                    <span className="text-sm text-gray-700">info@birlainternational.net</span>
                  </div>
                </div>
              </div>
            </CardContent>
        ...
        <div className="mb-16 fade-in-up">
          <Card className="glass-card hover-lift shimmer-effect">
            <CardHeader>
              <CardTitle className="text-2xl font-bold gradient-text flex items-center gap-2" data-testid="text-investor-grievances-title">
        ...
        <div className="mb-16 fade-in-up">
          <Card className="glass-card hover-lift shimmer-effect">
            <CardHeader>
              <CardTitle className="text-2xl font-bold gradient-text flex items-center gap-2" data-testid="text-services-title">
                <Target className="h-7 w-7 text-blue-600 bounce-in" />
                Our Services
              </CardTitle>
              <p className="text-gray-600 mt-2">Comprehensive financial and investment solutions tailored to your needs</p>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-lg">
                  <TrendingUp className="h-8 w-8 text-blue-600 mb-4" />
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">Investment Advisory</h4>
                  <p className="text-sm text-gray-700">
                    Expert guidance for NRI and domestic investors in investment planning and portfolio management
                  </p>
                </div>
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-lg">
                  <Shield className="h-8 w-8 text-green-600 mb-4" />
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">Financial Planning</h4>
                  <p className="text-sm text-gray-700">
                    Comprehensive tax planning and financial strategy development for optimal growth
                  </p>
                </div>
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-lg">
                  <Building2 className="h-8 w-8 text-purple-600 mb-4" />
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">Corporate Services</h4>
                  <p className="text-sm text-gray-700">
                    Commercial, legal, and industrial consultancy with expert public relations support
                  </p>
                </div>
              </div>
            </CardContent>
