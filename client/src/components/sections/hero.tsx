  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white py-16 sm:py-20 gradient-shift particle-bg mobile-section">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute -top-4 -right-4 w-72 h-72 bg-purple-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 float-animation"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute -bottom-8 left-20 w-72 h-72 bg-pink-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 float-animation"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="space-y-4 stagger-children">
              <div className="mb-4">
                <div
                  className="inline-block bg-gradient-to-r from-blue-400 to-purple-400 text-white px-8 py-4 rounded-xl font-bold text-4xl sm:text-5xl lg:text-7xl shadow-2xl transform hover:scale-105 transition-transform duration-300 glow-on-hover"
              ...
              <h1
                className="text-3xl sm:text-4xl lg:text-6xl font-bold leading-tight text-white drop-shadow-lg typewriter hero-title"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 py-4 sm:py-6 fade-in-up mobile-card-grid">
              <div className="text-center glass-card p-3 sm:p-4 hover-lift">
                ...
                <p className="text-xs sm:text-sm text-blue-200 mobile-text-base">
                  Growth Focused
                </p>
              </div>
              <div className="text-center glass-card p-3 sm:p-4 hover-lift">
                <Shield
                  className="h-6 w-6 sm:h-8 sm:w-8 mx-auto mb-2 text-blue-400 bounce-in"
              ...
              <div className="text-center glass-card p-3 sm:p-4 hover-lift">
                <Sparkles
                  className="h-6 w-6 sm:h-8 sm:w-8 mx-auto mb-2 text-purple-400 bounce-in"
          ...
          <div className="hidden lg:block relative">
            ...
            <div
              className="absolute -bottom-4 -left-4 w-8 h-8 bg-gradient-to-r from-green-400 to-blue-500 rounded-full shadow-lg float-animation opacity-80"
              style={{ animationDelay: "1s" }}
            ></div>
            <div
              className="absolute top-1/2 -left-8 w-6 h-6 bg-gradient-to-r from-purple-400 to-pink-500 rounded-full shadow-lg float-animation opacity-80"
