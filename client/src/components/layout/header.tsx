...
export default function Header() {
  ...
  const investorLinks = [
    ...
    {
      href: "/investor-relations",
      label: "Quarterly Corporate Governance Report",
  ...
  const policiesLinks = [
    ...
    {
      href: "/policies",
      label: "Policy Related to Party Transaction",
    ...
    {
      href: "/policies",
      label: "Code for Prohibition of Insider Trading",
    ...
    {
      href: "/policies",
      label: "Material Subsidiary Policy",
    ...
    {
      href: "/policies",
      label: "Familiarizations Programme",
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden lg:block flex-1 mx-4">
            <div className="flex items-center justify-center space-x-2 xl:space-x-6">
              <DropdownMenu>
                <DropdownMenuTrigger
                  className="text-gray-900 hover:text-primary hover:bg-blue-50 transition-colors flex items-center py-2 px-2 xl:px-3 rounded-md whitespace-nowrap text-sm xl:text-base"
              ...
              <DropdownMenu>
                <DropdownMenuTrigger
                  className="text-gray-900 hover:text-primary hover:bg-blue-50 transition-colors flex items-center py-2 px-2 xl:px-3 rounded-md whitespace-nowrap text-sm xl:text-base"
                  data-testid="nav-investor-dropdown"
                >
                  Investor Relations{" "}
                  <ChevronDown className="ml-1 h-3 w-3 xl:h-4 xl:w-4" />
                </DropdownMenuTrigger>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger
                  className="text-gray-900 hover:text-primary hover:bg-blue-50 transition-colors flex items-center py-2 px-2 xl:px-3 rounded-md whitespace-nowrap text-sm xl:text-base"
                  data-testid="nav-policies-dropdown"
                >
                  Code and Policies{" "}
                  <ChevronDown className="ml-1 h-3 w-3 xl:h-4 xl:w-4" />
                </DropdownMenuTrigger>
