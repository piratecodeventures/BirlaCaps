        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-blue-100">
              Leading financial services company empowering India's financial future through innovative solutions and governance excellence.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/board-directors" className="text-blue-200 hover:text-white transition-colors" data-testid="footer-board">Board of Directors</Link></li>
              <li><Link href="/company-secretary" className="text-blue-200 hover:text-white transition-colors" data-testid="footer-secretary">Company Secretary</Link></li>
              <li><Link href="/policies" className="text-blue-200 hover:text-white transition-colors" data-testid="footer-governance">Governance</Link></li>
              <li><Link href="/grievances" className="text-blue-200 hover:text-white transition-colors" data-testid="footer-complaints">Investor Grievances</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="text-blue-200">
                ...
                <p className="mb-2">✉️ info@bcfsl.com</p>
                <p>🌐 CIN: L65999MH1995PLC086890</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-blue-600 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <span className="text-blue-200 text-sm">Listed on BSE Limited</span>
            </div>
          </div>
        </div>
      </div>
